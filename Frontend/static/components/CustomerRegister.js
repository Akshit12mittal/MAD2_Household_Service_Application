const CustomerRegister = {
                    ...
                    <div class="card-body p-5">
                        ...
                        <form @submit.prevent="registerCustomer">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="address" v-model="formData.address" placeholder="Address" style="height: 100px" required></textarea>
                                        <label for="address">Address</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="pincode" v-model="formData.pincode" placeholder="Pincode" required>
                        ...
                        <div class="text-center mt-3">
                            ...
                            <p class="text-white">Are you a service professional? 
    ...
    mounted: function() {
        document.title = "Customer Registration - Rise Home Services";
    }
};
